...
public class ApplicationBaseException extends Exception 
{
	...
	/**
	 * This is a parameterised constructor for the BaseException class. It expects String (error code,errorMessage)
	 ...
	 */
	public ApplicationBaseException(String errorCode,String errorMessage, Throwable cause)
	{
	 ...
	 *
	 */
	public ApplicationBaseException(String errorCode,String errorMessage)
	{
		super(errorMessage);
		this.errorCode = errorCode;
		this.errorMessage = errorMessage;
