...
<div>
	...
	<div>
		<span style="font-size: x-large"><s:property
				value="getText('sub.header.workOrder')" /></span>
		<s:form action="WorkOrderFileUpload" theme="simple"
			...
			<span class="input-group form-inline "> <span
				class="input-group-btn"> <span
					...
					placeholder="Upload Work Order Excel" /> &nbsp; <s:submit
	...
	<div class="panel panel-primary" style="position: relative;">
		...
		<div class="panel-body" style="padding: 5px 1px">
				...
				<s:form id="searchFormId" theme="simple">
					<fieldset>
						...
						<s:select
							...
							name="woStat" emptyOption="false" value="%{woStat}"
							cssClass="input-sm" />
						...
						<s:textfield name="woId" id="woId" placeholder="Work Order Id"
							cssClass="input-sm" />
			...
			<s:url id="remoteUrl" action="workOrderResult" />
			<sjg:grid id="workOrderGrid" dataType="json" href="%{remoteUrl}"
				...
				reloadTopics="reloadWorkOrderGrid">

				<sjg:gridColumn name="workOrderId" index="workOrderId" key="true"
					title="%{getText('sjGrid.workOrderId')}" align="left"
				...
				<sjg:gridColumn name="completedDate" index="completedDate"
					title="%{getText('sjGrid.wocompleteddate')}" align="center"
					resizable="true" sortable="true" width="4"
					cssStyle="font-family:Arial; font-size:8;" formatter='date'
					formatoptions="{ srcformat: 'ISO8601Long', newformat: 'd/m/Y H:i:s'}">
				</sjg:gridColumn>
